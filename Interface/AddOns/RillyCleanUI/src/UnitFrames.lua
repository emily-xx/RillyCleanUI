...
RillyCleanUnitFrames:SetScript("OnEvent", function()
	...
	function StylePlayerFrame(self, isVehicle)
		...
		PlayerFrameAlternateManaBar:SetStatusBarTexture(RILLY_CLEAN_TEXTURES.statusBar)
		PlayerFrameManaBar.FeedbackFrame.BarTexture:SetTexture(RILLY_CLEAN_TEXTURES.statusBar)
		PlayerFrameManaBar.FeedbackFrame.LossGlowTexture:SetTexture(RILLY_CLEAN_TEXTURES.statusBar)
		PlayerFrameManaBar.FeedbackFrame.GainGlowTexture:SetTexture(RILLY_CLEAN_TEXTURES.statusBar)
		PlayerFrameManaBar.texture:SetTexture(RILLY_CLEAN_TEXTURES.statusBar)
